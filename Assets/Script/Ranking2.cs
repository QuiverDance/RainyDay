...
public class Ranking2 : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        arr = new string[5];
        //AllRecordRead();
        nscore = DataCenter.instance.gameData.normalScore[0];
        normal_score = ProcessFloatData(nscore);
        //RankingRecord();
    }
    ...
    {
        plugin.RankingRecord("rainyday-RANK-B687259E-81094ACD", (int)nscore * 100, normal_score, (state, message, rawData, dictionary) => {
    ...
    public void AllRecordRead()
    {
        ...
        plugin.Ranking("rainyday-RANK-B687259E-81094ACD", (int)5, (state, message, rawData, dictionary) => {
            if (state.Equals(Configure.PN_API_STATE_SUCCESS))
            {
                Debug.Log("Success");
